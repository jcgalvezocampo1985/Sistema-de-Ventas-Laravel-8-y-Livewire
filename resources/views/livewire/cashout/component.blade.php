                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="fromDate" class="form-control flatpickr" />
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="toDate" class="form-control flatpickr" />
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button wire:click.prevent="viewDetails({{ $row }})" class="btn bg-dark btn-sm">
